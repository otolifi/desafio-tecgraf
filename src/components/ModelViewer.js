...
function loadGeometry(path, color, group, numberOfModels, modelIndex) {
    ...
    function init() {
        ...
        cube.userData['group_letter'] = 'Grupo A';
        scene.current.add(cube);
        selectable.current.push(cube);

        geometry = new THREE.BoxGeometry( 3, 3, 3 );
        material = new THREE.MeshPhongMaterial({color: 0xff0000});
        cube = new THREE.Mesh(geometry, material)
        cube.userData['group_letter'] = 'Grupo B';
        cube.position.x = 5;
        scene.current.add(cube);
        selectable.current.push(cube);
        ...
        material = new THREE.MeshPhongMaterial({color: 0xff0000});
        cube = new THREE.Mesh(geometry, material)
        cube.userData['group_letter'] = 'Grupo C';
        cube.position.x = 10;
        scene.current.add(cube);
        selectable.current.push(cube);
        ...
        material = new THREE.MeshPhongMaterial({color: 0xff0000});
        cube = new THREE.Mesh(geometry, material)
        cube.userData['group_letter'] = 'Grupo D';
        cube.position.x = 15;
        scene.current.add(cube);
        selectable.current.push(cube);
        */
        ...
        //directionalLight.position.x = 20000;
        //directionalLight.position.z = 20000;
        //directionalLight.rotation.y = Math.PI / 4;
        //scene.current.add( directionalLight );
        //let pointLight = new THREE.PointLight(0xffffff, 10000, 10000);
        ...
        */
        ...
        //colors = [0xFF13D1, 0x00FF00, 0xFFA5A5, 0x385067, 0x00FFFF, 0xFF00FF, 0x55626D, 0xFFF4A5 ,0xD6D6D6, 0x0FFF00, 0xC2FF13, 0xFF0000, 0x0000FF, 0x13F1FF, 0xFF8C00, 0x80482C, 0x8C8C8C, 0xFFF000, 0x861D9B, 0x1C055E, 0x000000];
    ...
    function onMouseMove( event ) {
        //mouse.x = ( event.clientX - mountRef.current.left / mountRef.current.clientWidth ) * 2 - 1;
        //mouse.y = - ( event.clientY - mountRef.current.top / mountRef.current.clientHeight ) * 2 + 1;
